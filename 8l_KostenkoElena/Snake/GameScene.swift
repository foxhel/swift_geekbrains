...
//  Snake
//
//  Created by Elena Kostenko on 26/01/2021.
//
...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        self.physicsBody?.collisionBitMask = CollisionCategories.Snake | CollisionCategories.SnakeHead | CollisionCategories.EdgeBody
